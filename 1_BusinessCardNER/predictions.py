...
def parser(text,label):
    if label == 'PHONE':
        ...
        text = text.title() # First character capital   
...
def getPredictions(image):
    ...
    df_clean = df.query('text != "" ') #not equal to empty space
    ...
    # Join token dataframe with Pytesseract / join label to df_clean dataframe
